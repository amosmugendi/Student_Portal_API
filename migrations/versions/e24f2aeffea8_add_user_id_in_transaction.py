"""add user_id in Transaction

Revision ID: e24f2aeffea8
Revises: 
Create Date: 2024-08-13 01:59:38.493267
...
def upgrade():
    ...
    sa.Column('trans_for', sa.String(), nullable=True),
    ...
    sa.Column('payer_names', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
